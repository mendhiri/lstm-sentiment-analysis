...
base_url = 'https://nitter.net/search?f=tweets&q=TNI+lang%3Aid+since%3A2025-03-10+until%3A2025-03-29+-filter%3Aretweets'
...
try:
    ...
    query = 'TNI lang:id since:2025-03-10 until:2025-03-29 -filter:retweets'
    ...
    output_path = "scraped_tni_tweets.csv"
